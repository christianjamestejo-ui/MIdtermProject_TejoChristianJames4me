        ...
        public void Execute(List<Student> students)
        {
            ...
            while (running)
            {
                ...
                while (inputting)
                {
                    ...
                    if (middleInitial.Length < 1 || middleInitial.Length > 1)
                    {
                ...
                while (inputtingContactNumber)
                {
                    ...
                    int maxAllowed = 999999999;
                    if (!int.TryParse(number, out contactNumber) && contactNumber < 1 && contactNumber > maxAllowed)
                    {
            ...
            Console.WriteLine("\nPress any key to return to menu...f");
            Console.ReadKey();
        }
    }
