...
using static MidtermProject.EnrollStudent;

namespace MidtermProject
{
    /// <summary>
    /// Represents the available menu options in the main program.
    /// </summary>
    ...
    /// <summary>
    /// Helper enum used for boolean style input states.
    /// </summary>
    ...
    /// <summary>
    /// Represents a student and their personal and academic information.
    /// </summary>
    ...
    /// <summary>
    /// Represents a student who has enrolled in subjects.
    /// </summary>
    ...
    /// <summary>
    /// Represents a school subject with ID and description.
    /// </summary>
    ...
    /// <summary>
    /// Stores the master list of available subjects.
    /// </summary>
    public static class SubjectList
    {
        ...
        new Subject { SubjectID="IT-101A", SubjectName="INTRODUCTION TO COMPUTING - " +
            "Subject that delves into the general knowledge of computers."},
        new Subject { SubjectID="IT-102A", SubjectName="COMPUTER PROGRAMMING 1 - " +
            "Subject that teaches about writing code for software."},
        new Subject { SubjectID="IT-103A", SubjectName="INTRODUCTION TO HUMAN COMPUTER INTERACTIONS - " +
            "Subject that teaches to design UI(User-Interface) for software."},
        new Subject { SubjectID="MATH-105A", SubjectName="DISCRETE MATHEMATICS - " +
            "Subject that teaches general calculative algebraic mathematics."},
        new Subject { SubjectID="GEC-101A", SubjectName="MATHEMATICS IN THE MODERN WORLD - " +
            "Subject that introduces various uses of mathematics in the day to day environment."},
        new Subject { SubjectID="GEC-102A", SubjectName="PHILIPPINE POPULAR CULTURE - " +
            "Subject that delves in the contemporary culture of the Philippines."},
        new Subject { SubjectID="PE-101A", SubjectName="PHYSICAL EDUCATION 1 - " +
            "Subject that teaches physical fitness management and testing."},
        new Subject { SubjectID="THEO-101A", SubjectName="INTRODUCTION TO CATHOLIC FAITH 1 - " +
            "Introductory subject of the Catholic traditions and the Church."},
        new Subject { SubjectID="COMP-102IT", SubjectName="COMPUTER APPLICATIONS - " +
            "Subject that teaches on practices of application development."},
        ...
        new Subject { SubjectID="IT-105A", SubjectName="PLATFORM TECHNOLOGIES - " +
            "Subject that introduces the steps in making software."},
        new Subject { SubjectID="IT-106A", SubjectName="IT SOCIAL AND PROFESSIONAL ISSUES - " +
            "Subject that studies the guidelines of ethical professionalism in IT."},
        new Subject { SubjectID="GEC-103A", SubjectName="UNDERSTANDING THE SELF - " +
            "Subject that delves on philosophical understanding of oneself."},
        new Subject { SubjectID="GEC-104A", SubjectName="ART APPRECIATION - " +
            "Subject that teaches concepts of art criticism."},
        new Subject { SubjectID="RZL-101A", SubjectName="LIFE AND WORKS OF RIZAL - " +
            "Subject that introduces Rizal's life and works."},
        new Subject { SubjectID="PE-102A", SubjectName="PHYSICAL EDUCATION 2 - " +
            "Subject that introduces various sports of the Philippines."},
        new Subject { SubjectID="THEO-102A", SubjectName="SCRIPTURES, THE SACRAMENTS AND LITURGY - " +
            "Subject that teaches the Catholic Sacraments and traditional practices."}
        };
    }
    ...
    {
        /// <summary>
        /// Program entry point. Displays the menu and routes user actions.
        /// </summary>
    ...
    /// <summary>
    /// Handles the registration of new students and stores their information.
    /// </summary>
    public class RegisterStudent
    {
        /// <summary>
        /// Collects student details, validates inputs, and saves them to a text file.
        /// </summary>
        public void Execute(List<Student> students)
        {
            ...
            while (running)
            {
                ...
                // Collect birthdate and calculate age
                DateTime birthDate;
    ...
    /// <summary>
    /// Handles enrolling a registered student into subjects.
    /// </summary>
    public class EnrollStudent
    {
        // Executes the subject enrollment process for a selected student.
        /// <summary>
        /// Loads registered students from file, allows subject selection,
        /// and saves the enrolled subjects to a JSON file.
        /// </summary>
        public void Execute(List<Student> students)
        {
            Console.Clear();
            ...
            // Map full student info into enrolled student object
            ...
            // Save enrolled student data to JSON
    ...
    /// <summary>
    /// Handles the input and storage of student grades.
    /// </summary>
    public class GradeStudent
    {
        // Executes the grade entry process for enrolled students.
        /// <summary>
        /// Loads enrolled students, prompts the user to enter grades,
        /// and records the grades to a file.
        /// </summary>
        public void Execute(List<Student> students)
        {
            Console.Clear();
    ...
    /// <summary>
    /// Displays recorded grades of students.
    /// </summary>
    public class ShowGradeStudent
    {
        // Executes the process of reading and displaying stored grades.
        /// <summary>
        /// Reads the grade file and prints the stored information to the console.
        /// </summary>
        public void Execute(List<Student> students)
        {
            Console.Clear();
